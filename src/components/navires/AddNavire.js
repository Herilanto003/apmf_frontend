...
const AddNavire = ({ open, handleClose }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            await axios.post('/api/navire/new', values, confHead)
                    .then(resp => {
                        console.log(resp);
                        handleRefresh();
                    })
    ...
    return (
        ...
        >
            ...
            <form>
                ...
                <DialogActions>
                    <Button size='small' onClick={formik.handleReset} startIcon={<Cancel />} variant='contained' color='error'>Fermer</Button>
                    <Button size='small' onClick={formik.handleSubmit} startIcon={<Save />} variant='contained' >Enregistrer</Button>
                </DialogActions>
            </form>
        </Dialog>
    );
